...
import me.braun.spacex.dao.IStatusDAO;
import me.braun.spacex.entity.Role;
import me.braun.spacex.entity.Status;
...
public class SQLStatusDAO implements IStatusDAO {
    ...
    public Status save(Status status) throws IllegalStateException {
        ...
        String query = "insert into spacex_agency_system.statuses(status) " +
                "values (?);";
        try {
    ...
    public void delete(Short id) {
        ...
        String query = "delete statuses from " +
